$(function () {
    ...
    function addRow(account_name, status, mode_datetime) {
        ...
        row.append($('<td></td>').addClass('px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white').text(status));
        row.append($('<td></td>').addClass('px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white').text(mode_datetime));
